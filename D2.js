...
let numero1 = 5;
let numero2 = 3;
let prezzoProdotto = 50; // Sostituisci con il prezzo effettivo del prodotto
let scontoBlackFriday = 0.2; // 20%

// Verifica se uno dei numeri è 8 o se la loro somma/sottrazione è uguale a 8
if (numero1 === 8 || numero2 === 8 || numero1 + numero2 === 8 || (numero1 - numero2 === 8) || (numero2 - numero1 === 8)) {
    // Applica lo sconto del 20% per il Black Friday
    prezzoProdotto = prezzoProdotto - (prezzoProdotto * scontoBlackFriday);
    
    // Verifica se le spedizioni sono gratuite
    let spedizioniGratuite = true; // Sostituisci con la tua logica per determinare se le spedizioni sono gratuite o no
    
    // Calcola il totale
    let totale = spedizioniGratuite ? prezzoProdotto : prezzoProdotto + costoSpedizioni;
